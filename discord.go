...
func (b *mtdBot) toDiscord(m message) {
	switch m.Type {
	case "chat":
		b.Discord.ChannelMessageSend(b.Config.Discord.ChannelID, "<"+m.PlayerName+"> "+m.MessageText)
	case "system":
		b.Discord.ChannelMessageSendEmbed(b.Config.Discord.ChannelID, &discordgo.MessageEmbed{
			Title:       m.TitleText,
